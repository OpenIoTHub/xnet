...
type RequestInfo struct {
	...
	Headers   []Kv
	ClientIP  string
	//ClientGeo *xgeo.IpGeo // TODO
	ProxyDetected bool
	ProxyIP       string
	//ProxyGeo *xgeo.IpGeo // TODO
	UserAgentDetect *xhttp.UserAgnetInfo
...
func ParseRequest(ctx *fasthttp.RequestCtx) (*RequestInfo, error) {
	...
	ri.UserAgentDetect, _ = xhttp.ParseUserAgent(string(ctx.UserAgent()))
